...
Dsy.prototype.getProvince = function()
{
	...
	return this.Items[0].join(",");
}

Dsy.prototype.getCity = function(id)
{
	return this.Items['0_'+id].join(",");
}

Dsy.prototype.getCounty = function(pro_id,city_id)
{
	var county_arr = this.Items['0_'+(pro_id)+'_'+(city_id)]
	// console.log(county_arr);
	if(county_arr == undefined) county_arr = [];
	return county_arr.join(",");
}
