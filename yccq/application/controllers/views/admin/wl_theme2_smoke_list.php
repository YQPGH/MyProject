...
<div class=" main">
    <div class="layui-tab">
        ...
        <br>
        <div class="top">
           <span>《烟草传奇》主题游戏活动方案真龙(<?= $tab_type ?>)样品烟B</span>
            <form action="<?= $this->baseurl.'theme_list_2' ?>" method="post" style="float: right">
...
//        var obj_lis = document.getElementById("tab_list").getElementsByTagName("li");
//
...
//    };
    ...
    $(document).ready(function () {
        ...
        $("#tab_list li").on("click", function (event) {
            ...
            window.location.href = "<?=base_url()?>/admin/wldetail/theme_list_2?tab_type="+target;
        });
