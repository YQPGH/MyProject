...
<div class=" main">
    <div class="top">
        <span>用户邀请记录</span>
        <form action="<?= $this->baseurl.'invite_list' ?>" method="post" style="float: right">
    ...
    <table class="layui-table" lay-skin="line">
        ...
        <tr>
            ...
            <th width="100">好友ID</th>
            <th width="100">友好昵称</th>
            <th width="150">邀请/ 更新时间</th>
