...
<div class=" main">
    ...
    <form action="<?= $this->baseurl . 'save'; ?>" method="post" class="w900 layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    <label class="layui-form-label">购买乐币</label>
                    <div class="layui-input-inline">
                        <input type="text" name="value[money]" value="<?= $value['money'] ?>" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label">购买乐豆</label>
                    <div class="layui-input-inline">
            ...
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                    <textarea name="value[description]" class="layui-textarea" style="width: 600px;"><?= $value['description'] ?></textarea>
                </div>
            </div>
            ...
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                    <textarea name="value[json_data]" class="layui-textarea" style="width: 600px;"><?= $value['json_data'] ?></textarea>
                </div>
            </div>
