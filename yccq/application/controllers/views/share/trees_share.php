...
<head>
    ...
    <title></title>
    <link rel="stylesheet" style="text/css" href="<?= base_url()?>static/invite/css/trees_style.css">
    <link rel="stylesheet" style="text/css" href="<?= base_url()?>static/invite/css/flexible.css">

</head>
<body>
<img id="manager" src="<?= base_url()?>static/invite/images/trees/manager.png">
<div class="bg">
    <div id="msg" ></div>
    ...
    $(document).ready(function () {
        ...
        $('.submit').click(function(){
         ...
         var incode = $('#incode').val();
             ...
             $.post("<?= base_url()?>api/energytrees/accessInvite",
             {
             uid:uid,
             content:content,
             incode:incode
