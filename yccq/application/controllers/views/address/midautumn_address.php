...
<head>
    ...
    <link rel="stylesheet"  href="<?= base_url()?>static/address/css/midautumn_style.css">
</head>

<body>
<img id="body" src="<?= base_url()?>static/address/images/midautumn/bg_01.png">
<div id="msg" ></div>
<div id="pop">
    <form id="form-body" action="" method="post" enctype="multipart/form-data" onsubmit="return false">
        <div class="form-row">
            <div id="text_img">
                <img src="<?= base_url()?>static/address/images/midautumn/text.png">
            </div>
        </div>
        <div class="form-row">
