...
<head>
    ...
    <script src="<?= base_url()?>static/invite/flexible.js"></script>
    <title>呼朋唤友，一“荐”双赢</title>
    <link rel="stylesheet" style="text/css" href="<?= base_url()?>static/invite/css/style.css?05">
    ...
    $(document).ready(function () {
        ...
        $('#sub').click(function(){
         ...
         var incode = $('#incode').val();
             ...
             $.post("<?= base_url()?>api/laxin/user_binding",
             {
             uid:uid,
             content:content,
             incode:incode
