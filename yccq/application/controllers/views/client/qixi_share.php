...
<head>
    ...
    <link rel="stylesheet" style="text/css" href="<?= base_url()?>static/invite/css/qixi_style.css?01">
...
<div class="bg">
    ...
    <form action="" method="post" enctype="multipart/form-data"   onsubmit="return false">
        ...
        <div id="word">
            <p style="color:#a0c0f0" ><?=$nickname?></p>
            <p ><?=$content?></p>
        </div>
    ...
    $(document).ready(function () {
        ...
        $('#sub').click(function(){
         ...
         var incode = $('#incode').val();
             ...
             $.post("<?= base_url()?>api/qixi/invite_accept",
             {
                 uid:uid,
                 content:content,
                 incode:incode
