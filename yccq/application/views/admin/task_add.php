    ...
    <form action="<?= $this->baseurl . 'save'; ?>" method="post" class="w900 layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                <label class="layui-form-label">闪电</label>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input <?php if($value['shop_name']){ echo 'disabled="disabled"';} ;?> type="text" name="" value="<?= $value['shop_name'] ?>" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">商品编号</label>
                <div class="layui-input-inline">
                     <input type="text" name="value[shop1]" value="<?= $value['shop1'] ?>" class="layui-input">                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">商品数量</label>
                <div class="layui-input-inline">
                    <input type="text" name="value[shop1_total]" value="<?= $value['shop1_total'] ?>" class="layui-input">
                </div>
            </div>
        </div>
