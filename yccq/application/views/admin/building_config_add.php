    ...
    <form action="<?= $this->baseurl . 'save'; ?>" method="post" class="w900 layui-form">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label">建筑编号</label>
                <div class="layui-input-inline">
                    <input type="text" name="value[order]" value="<?= $value['order'] ?>" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
            ...
            <div class="layui-inline">
                <label class="layui-form-label">等级开启</label>
                <div class="layui-input-inline">
                    <input type="text" name="value[lv]" value="<?= $value['lv'] ?>" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">瓦石数量</label>
                <div class="layui-input-inline">
                    <input type="text" name="value[shopid_num1]" value="<?= $value['shopid_num1'] ?>" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">木材数量</label>
                <div class="layui-input-inline">
                    <input type="text" name="value[shopid_num2]" value="<?= $value['shopid_num2'] ?>" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">油漆数量</label>
                <div class="layui-input-inline">
                    <input type="text" name="value[shopid_num3]" value="<?= $value['shopid_num3'] ?>" class="layui-input">
                </div>
            </div>
        </div>
