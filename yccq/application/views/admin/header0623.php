                    ...
                    <li class="layui-nav-item layui-nav-itemed">
                        ...
                        <dl class="layui-nav-child">
                            <dd class="<?= side_show('log_shop','money') ?><?= permission('SYS_Ranking_money','read')?' show':' layui-hide'; ?>">
                                <a href="<?= site_url('admin/log_shop/money')?>">玩家银元消耗排行</a>
                            </dd>
                    ...
                    <li class="layui-nav-item layui-nav-itemed">
                        ...
                        <dl class="layui-nav-child">
                            <dd class="<?= side_show('laxin','index') ?><?= permission('SYS_Laxin','read')?' show':' layui-hide'; ?>">
                                <a href="<?= site_url('admin/laxin/index') ?>">拉新纪录</a>
                            </dd>
                            ...
                            <dd class="<?= side_show('laxin','invite_list') ?><?= permission('SYS_Laxin','read')?' show':' layui-hide'; ?>">
                                <a href="<?= site_url('admin/laxin/invite_list') ?>">拉新邀请纪录</a>
                            </dd>
                        </dl>
                    </li>
                    <li class="layui-nav-item layui-nav-itemed">
                        ...
                        <dl class="layui-nav-child">
<!--                            <dd class="--><?//= side_show('fragment','scan') ?><!----><?//= permission('SYS_Fragment_ScanRecord','read')?' show':' layui-hide'; ?><!--">-->
<!--                                <a href="--><?//= site_url('admin/fragment/scan') ?><!--">扫码获取原料纪录</a>-->
<!--                            </dd>-->
...
<!--                            </dd>-->
                            <dd class="<?= side_show('task') ?><?= permission('SYS_Task_record','read')?' show':' layui-hide'; ?>">
                                <a href="<?= site_url('admin/task/index') ?>">任务纪录</a>
                            </dd>
...
<!--                <ul class="layui-nav layui-nav-tree site-demo-nav">-->
<!--                    <li class="layui-nav-item layui-nav-itemed">-->
<!--                        <a class="javascript:;" href="javascript:;">活动配置管理</a>-->
<!--                        <dl class="layui-nav-child">-->
<!--                            <dd class="--><?//= side_show('holiday_activities','config_list1') ?><!--">-->
<!--                                <a href="--><?//= site_url('admin/holiday_activities/config_list1') ?><!--">端午奖品配置</a>-->
<!--                            </dd>-->
<!--                            <dd class="--><?//= side_show('holiday_activities','config_list2') ?><!--">-->
<!--                                <a href="--><?//= site_url('admin/holiday_activities/config_list2') ?><!--">国庆活动配置</a>-->
<!--                            </dd>-->
<!---->
<!--                            <dd class="--><?//= side_show('holiday_activities','config_list3') ?><!--">-->
<!--                                <a href="--><?//= site_url('admin/holiday_activities/config_list3') ?><!--">元旦活动配置</a>-->
<!--                            </dd>-->
<!--                        </dl>-->
<!--                        </dl>-->
<!--                    </li>-->
