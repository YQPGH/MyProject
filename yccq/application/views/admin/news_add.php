    ...
    <form action="<?= $this->baseurl . 'save'; ?>" method="post" class="w900 layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="value[thumb]" class="layui-input " value="<?= $value['thumb'] ?>" id="thumb">
            </div>
            <input type="file" name="file" class="layui-upload-file" id="btn_thumb">
        </div>
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label">* 内容</label>
            <div class="layui-input-block">
                <textarea class="layui-textarea layui-hide" name="value[content]" lay-verify="content"
                          id="editor"><?= $value['content'] ?></textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
