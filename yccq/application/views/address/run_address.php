...
<head>
    ...
    <link rel="stylesheet"  href="<?= base_url()?>static/address/css/run_style.css">
</head>

<body>
<img id="body" src="<?= base_url()?>static/address/images/run/bg_01.png">
<div id="msg" ></div>
<div id="pop">
    <form id="form-body" action="" method="post" enctype="multipart/form-data" onsubmit="return false">
        <div class="form-row">
            <div id="text_img">
                <img src="<?= base_url()?>static/address/images/run/text.png">
            </div>
        </div>
        <div class="form-row">
        ...
        <span class="tips">温馨提示：请填写真实地址详情，填写后点击提交按钮即为填写成功，提交后不可修改。</span>
