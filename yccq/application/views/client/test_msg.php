...
<div id="pop">
    <form id="form-body" action="" method="post" enctype="multipart/form-data" onsubmit="return false">
        ...
        <div class="form-row">
            ...
            <input class="form-input" id="truename" name="truename" type="text" value="">
        ...
        <div class="form-row">
            ...
            <input class="form-input"  id="phone" type="tel" name="phone" value="">
        </div>
        <div class="form-row">
        ...
        <div class="form-row">
            ...
            <textarea class="form-textarea" name="street" id="street" cols="29" rows="6"><?= $id?></textarea>
        </div>
...
$("#county").focus(function(){
    ...
    $(document).ready(function(){
        ...
        $('select').change(function(){
            ...
            $.post("<?='http://'.$_SERVER['HTTP_HOST'].'/yccq/'?>api/address/get_address",
                {
                    name:name,
        ...
        $('.btn_submit').click(function(){
            ...
            $.post("<?= 'http://'.$_SERVER['HTTP_HOST'].'/yccq/'?>api/leaf/savemessage",
                {
                    uid:uid,
                    id:id,
                    truename:truename,
    ...
    function alertfun(txt) {
        ...
        if(txt.code == 0){
            txt.msg = "保存成功！";
            redirect('<?= 'http://'.$_SERVER['HTTP_HOST'].'/yccq/'?>api/main/index', 1);
        }
