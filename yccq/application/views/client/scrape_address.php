	...
	<body>
		...
		<script type="application/javascript">
		    ...
		    $(document).ready(function(){
		        ...
		        $('.submit-btn').click(function(){
	                ...
	                if (truename == '' || phone == '' || street == '') {
				        ...
				        pass.innerHTML = escapeHTML("请填写完整信息");
				        setTimeout(function(){
	                ...
	                if(!(/^1[3456789]\d{9}$/.test(phone))){
		                $("#msg").css('display','block');
				        var pass = document.getElementById('msg');
				        pass.innerHTML = escapeHTML("手机号码有误");
				        setTimeout(function(){
				            $("#msg").css('display','none');
				        },2000);
		                return false;
		            ...
		            $.ajax({
		                ...
		                complete: function () {
		                    ...
		                    $("#msg").css('display','block');
					        var pass = document.getElementById('msg');
					        pass.innerHTML = escapeHTML("提交成功");
					        setTimeout(function(){
					            $("#msg").css('display','none');
					        },2000);
					    },
		    ...
		    function alertfun(txt) {
		        ...
		        pass.innerHTML = escapeHTML(txt.msg);
		        setTimeout(function(){
		            $("#msg").css('display','none');
		        },2000);
		    ...
		    function checkPhone(obj){
		        ...
		        if (phone) {
		            ...
		            $("#msg").css('display','block');
			        var pass = document.getElementById('msg');
			        pass.innerHTML = escapeHTML("请填写手机号码");
			        setTimeout(function(){
			            $("#msg").css('display','none');
			        },2000);
	                return false;
