...
<head>
    ...
    <link rel="stylesheet"  href="<?= base_url()?>static/address/css/plantranking_style.css">
</head>
    ...
    <form id="form-body" action="" method="post" enctype="multipart/form-data" onsubmit="return false">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <img style="display: none" src="<?= base_url()?>static/address/images/plantranking/arrow.png" id="arrow1" class="arrow">
            </div>
        </div>
        <div class="form-row">
            ...
            <div class="form-group" style="width: 35%;">
                ...
                <img style="display: none" src="<?= base_url()?>static/address/images/plantranking/arrow.png" id="arrow2" class="arrow">
            </div>
            <div class="form-group" style="width: 35%;">
                ...
                <img style="display: none" src="<?= base_url()?>static/address/images/plantranking/arrow.png" id="arrow3" class="arrow">
...
$("#county").focus(function(){
    ...
    $(document).ready(function(){
        ...
        $('.btn_submit').click(function(){
            ...
            $.post("<?= base_url()?>api/plantaddress/savemessage",
                {
                    uid:uid,
                    id:id,
                    truename:truename,
