...
<head>
    ...
    <meta http-equiv="Content-Security-Policy" content="script-src 'self' 'unsafe-inline' https://res.wx.qq.com https://xccq.th00.com.cn 'unsafe-eval' https://xccq.th00.com.cn">
</head>
<style>
    .bg {
...
<?php 
     function getSignPackage() {
		...
		$get_jsSDK_url = 'http://xccq.th00.com.cn/yccq/api/WeiXin/getJsapiTicket?sign='.$sign;
...
var url_code = '';
 ...
 wx.config({
    ...
    function share(title, content, imgUrl) {
        var share_t = '整个朋友圈都在玩<香草传奇>，你还不快来！';
