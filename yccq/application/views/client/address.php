...
<head>
    ...
    <link rel="stylesheet"  href="<?= base_url()?>static/address/css/style.css?05">
    ...
    <form id="form-body" action="" method="post" enctype="multipart/form-data" onsubmit="return false">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <img style="display: none" src="<?= base_url()?>static/address/images/xiala.png" id="arrow1" class="arrow">
            </div>
        </div>
        <div class="form-row">
            ...
            <div class="form-group" style="width: 35%;">
                ...
                <img style="display: none" src="<?= base_url()?>static/address/images/xiala.png" id="arrow2" class="arrow">
            </div>
            <div class="form-group" style="width: 35%;">
                ...
                <img style="display: none" src="<?= base_url()?>static/address/images/xiala.png" id="arrow3" class="arrow">
            </div>
        </div>
        <div class="form-row">
            <label class="form-label form-textarea-label" for="">详  细<br/>地  址</label>
            <textarea class="form-textarea" name="street" id="street" cols="30" rows="8"><?= $street?></textarea>
        </div>
        <span class="tips">温馨提示：请填写真实地址详情，填写后点击提交按钮即为填写成功，提交后24小时内可进行修改。</span>
...
$("#county").focus(function(){
    ...
    $(document).ready(function(){
        ...
        $('.btn_submit').click(function(){
            ...
            $.post("<?= base_url()?>api/laxin/savemessage",
                {
                    uid:uid,
                    id:id,
                    truename:truename,
