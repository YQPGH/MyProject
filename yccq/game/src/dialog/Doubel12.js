 ...
 */
(function(){
    function Doubel12(type,data)
    {
        Doubel12.__super.call(this);
        this.DType = type;
        this.Data = data;
    ...
    Laya.class(Doubel12,'Doubel12',Doubel12UI);
    var proto = Doubel12.prototype;
    ...
    {
        var self =this;
        Utils.post('gift/getLdChangeGift',{uid:localStorage.GUID,type:this.DType,activity_type:2},function(res){
            console.log(res);
            if(res.code == 0){
