 ...
 */
(function(){
    function NewYearsDay(type,data)
    {
        NewYearsDay.__super.call(this);
        this.DType = type;
        this.Data = data;
    ...
    Laya.class(NewYearsDay,'NewYearsDay',NewYearsDayUI);
    var proto = NewYearsDay.prototype;
    ...
    {
        var self =this;
        Utils.post('gift/getLdChangeGift',{uid:localStorage.GUID,type:this.DType,activity_type:3},function(res){
            console.log(res);
            if(res.code == 0){
