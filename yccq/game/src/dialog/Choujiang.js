/**
 * Created by 41496 on 2017/10/17.
 */
//初级抽奖
var ChouJiang = (function(_super){
    var self = null;
    function ChouJiang(){
        ChouJiang.__super.call(this);
        self = this;
        this.list_data = [];
    ...
    Laya.class(ChouJiang,'ZY.ChouJiang',_super);
    var proto = ChouJiang.prototype;

    proto.getPrizeList = function()
    {
        Utils.post('prize/jifen_list',{uid:localStorage.GUID},this.onPrizeListReturn,onHttpErr);
    };
    ...
    proto.onStartBtnClick = function()
    {
        ...
        Utils.post('prize/jifen_result',{uid:localStorage.GUID},this.onResultReturn,onHttpErr);
        /*this.timer.once(10000,this,function(){
            this.des_num = Math.floor(Math.random()*(this.ItemList.length-1));
        });*/
    };
