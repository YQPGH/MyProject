 ...
 */
//高级抽奖
var ChouJiangGao = (function(_super){
    var self = null;
    function ChouJiangGao(shopid){
        ChouJiangGao.__super.call(this);
        self = this;
        this.shopid = 0;
        this.list_data = [];
    ...
    Laya.class(ChouJiangGao,'ZY.ChouJiangGao',_super);
    var proto = ChouJiangGao.prototype;

    proto.getPrizeList = function()
    {
        Utils.post('prize/yan5_list',{uid:localStorage.GUID},this.onPrizeListReturn,onHttpErr);
    };
    ...
    {
        var dialog = new SelectYan(5,this);
        dialog.popup();
    };
    ...
    proto.send = function(){
        ...
        Utils.post('prize/yan5_result',{uid:localStorage.GUID,shopid:this.shopid},this.onResultReturn,onHttpErr);
    };
